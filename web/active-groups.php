...
if ( isset($_POST['system']) )
  {
    ...
    echo "<TABLE border=\"1\">\n";
    echo "<TR><TH>group</TH><TH>users</TH><TH>accounts</TH><TH>job count</TH><TH>CPU-hours</TH><TH>nodehours</TH><TH>charges</TH></TR>\n";
...
else
  {
    ...
    $choices=array("cpuhours","nodehours","charges","jobs","users");

...
if ( isset($_POST['system']) )
  {
    ...
    echo "<TABLE border=\"1\">\n";
    echo "<TR><TH>account</TH><TH>users</TH><TH>groups</TH><TH>job count</TH><TH>CPU-hours</TH><TH>nodehours</TH><TH>charges</TH></TR>\n";

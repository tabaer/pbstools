...
if ( isset($_POST['system']) )
  {
    ...
    $queues = array();
    $sql = "SELECT DISTINCT(queue) FROM Jobs WHERE ( ".sysselect($_POST['system'])." ) AND ".dateselect($_POST['datelogic'],$_POST['start_date'],$_POST['end_date']);
    #echo "<PRE>\n".$sql."</PRE>\n";

...
if ( isset($_POST['system']) )
  {
    ...
    echo "<TABLE border=\"1\">\n";
    echo "<TR><TH>user</TH><TH>group</TH><TH>account</TH><TH>job count</TH><TH>CPU-hours</TH><TH>nodehours</TH><TH>charges</TH></TR>\n";

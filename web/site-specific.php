...
# OSC
  ...
  $case .= " WHEN account LIKE 'PXS%' THEN 'osc'";
  ...
  $case .= " WHEN account LIKE 'PASH%' THEN 'ash'";
  $case .= " WHEN account LIKE 'PBLU%' THEN 'blu'";
  $case .= " WHEN account LIKE 'PCCF%' THEN 'ccf'";
  $case .= " WHEN account LIKE 'PCCH%' THEN 'cch'";
  $case .= " WHEN account LIKE 'PCON%' THEN 'cond'";
  $case .= " WHEN account LIKE 'PCCR%' THEN 'ccri'";
  $case .= " WHEN account LIKE 'PCSC%' THEN 'cscc'";
  $case .= " WHEN account LIKE 'PCED%' THEN 'ced'";
  $case .= " WHEN account LIKE 'PDCH%' THEN 'dchs'";
  $case .= " WHEN account LIKE 'PDNU%' THEN 'dnu'";
  $case .= " WHEN account LIKE 'PFIN%' THEN 'find'";
  $case .= " WHEN account LIKE 'PFRU%' THEN 'fru'";
  $case .= " WHEN account LIKE 'PLCC%' THEN 'lake'";
  $case .= " WHEN account LIKE 'PMCO%' THEN 'mco'";
  $case .= " WHEN account LIKE 'PMIU%' THEN 'miu'";
  $case .= " WHEN account LIKE 'PMLC%' THEN 'mlc'";
  $case .= " WHEN account LIKE 'PMUS%' THEN 'musk'";
  $case .= " WHEN account LIKE 'PNAS%' THEN 'nasa'";
  $case .= " WHEN account LIKE 'PNGR%' THEN 'nasa'";
  $case .= " WHEN account LIKE 'PNRA%' THEN 'nrac'";
  $case .= " WHEN account LIKE 'POBC%' THEN 'obc'";
  $case .= " WHEN account LIKE 'PODU%' THEN 'odu'";
  $case .= " WHEN account LIKE 'PSAM%' THEN 'samc'";
  $case .= " WHEN account LIKE 'PSSU%' THEN 'ssu'";
  $case .= " WHEN account LIKE 'PWAU%' THEN 'wau'";
  $case .= " WHEN account LIKE 'PWBF%' THEN 'wbf'";
  $case .= " WHEN account LIKE 'PWIT%' THEN 'wit'";
  $case .= " WHEN account LIKE 'PWOO%' THEN 'woo'";
  $case .= " WHEN account LIKE 'PWSU%' THEN 'wsu'";
  $case .= " WHEN account LIKE 'PXAU%' THEN 'xau'";
